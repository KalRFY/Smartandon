<template>
  <CCard class="mt-3 mb-5">
    <CCardBody>
      <CRow v-if="loading">
        <CCol class="text-center py-5"> Loading data... </CCol>
      </CRow>
                ...
                <CTableHead>
                  <CTableRow class="bg-gray-100 text-center">
                    ...
                    <CTableHeaderCell colspan="2"
                      >CM Category (v)</CTableHeaderCell
                    >
                    <CTableHeaderCell colspan="12"
                      >Schedule Countermeasure</CTableHeaderCell
                    >
                  ...
                  <CTableRow class="bg-gray-50 text-center">
                    <CTableHeaderCell rowspan="2"
                      >Cause of Occurrence</CTableHeaderCell
                    >
                    <CTableHeaderCell rowspan="2"
                      >Cause of Delay</CTableHeaderCell
                    >
